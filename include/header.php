               ...
               <li class="nav-author">
                  <div class="dropdown-custom">
                     <a href="javascript:;" class="nav-item-toggle"><img src="img/author-nav.jpg" alt="" class="rounded-circle">
                        <span class="nav-item__title"><?php echo $_SESSION['nombre_user_hx'] ;?><i class="las la-angle-down nav-item__arrow"></i></span>
                     </a>
                     <div class="dropdown-parent-wrapper">
                        <div class="dropdown-wrapper">
                           <div class="nav-author__info">
                              ...
                              <div>
                                 <h6><?php echo $_SESSION['nombre_user_hx']." ".$_SESSION['apellido_user_hx'];?></h6>
                                 <span><?php echo $_SESSION['puesto_user_hx']; ?></span>
                              </div>
                           </div>
                           <div class="nav-author__options">
                              <ul>
                                 ...
                                 <li>
                                    <a href="">
                                       <i class="uil uil-key-skeleton"></i> Permisos</a>
                                 </li>
                                 <li>
                                    <a href="">
                                       <i class="uil uil-users-alt"></i> Actividad</a>
                                 </li>
                                 <li>
                                    <a href="">
                                       <i class="uil uil-bell"></i> Ayuda</a>
                                 </li>
                              </ul>
                              <a href="_logout.php" class="nav-author__signout">
                                 <i class="uil uil-sign-out-alt"></i> Cerrar Sesion</a>
                           </div>
                        </div>
