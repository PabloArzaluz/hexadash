               ...
               <div class="col-xxl-3 col-xl-4 col-md-6 col-sm-8">
                  <div class="edit-profile">
                     ...
                     <div class="card border-0">
                        ...
                        <div class="card-body">
                           <form action="_validar_acceso_hexa.php" method="post">
                           <div class="edit-profile__body">
                              <div class="form-group mb-25">
                                 <label for="username-hexa">Username</label>
                                 <input type="text" class="form-control" required id="username-hexa" name="username-hexa" placeholder="username">
                              </div>
                              <div class="form-group mb-15">
                                 <label for="password-field">password</label>
                                 <div class="position-relative">
                                    <input id="password-hexa" type="password" required class="form-control" name="password-hexa" placeholder="Password">
                        ...
                        <?php
                           ...
                           echo mensaje_esperado_get("error_log","alert","danger","Datos de Acceso Incorrectos");
                           //Cierre de Sesion Exitoso
                           echo mensaje_esperado_get("logout","alert","success","Sesion Cerrada Exitosamente");
                        ?>
